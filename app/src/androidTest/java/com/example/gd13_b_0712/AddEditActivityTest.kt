package com.example.gd13_b_0712
...
class AddEditActivityTest {
    ...
    fun addEditActivityTest() {
        ...
        textInputEditText.perform(scrollTo(), replaceText("Yesi"), closeSoftKeyboard())
        ...
        textInputEditText2.perform(scrollTo(), replaceText("200710712"), closeSoftKeyboard())
        ...
        textInputEditText3.perform(scrollTo(), replaceText("Informatika"), closeSoftKeyboard())
